...
## 2. Title Page (Student vs Professional)

### 2.1 Student Paper Title Page

Includes (centered, bold where indicated):

1. **Title of the paper** (bold, centered)
2. Author name(s)
...
### 2.2 Professional Paper Title Page
...
## 4. Headings (APA Heading Levels)

APA uses a **5-level heading system**:
...
| 4     | Indented, Bold, Title Case, Period. Text continues        |
| 5     | Indented, Bold Italic, Title Case, Period. Text continues |

---

## 5. In-Text Citations (Author–Date System)
...
## 7. Reference List (APA “References” Page)
...
### 8.4 Report / Organization Author

```
Organization Name. (Year).
Title of report. Publisher. URL
```
