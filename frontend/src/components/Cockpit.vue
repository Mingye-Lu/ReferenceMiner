...
<template>
  <div class="app-container">
    ...
    <ConfirmationModal v-if="showDeleteModal" title="Delete Chat?" message="Action cannot be undone."
      confirm-text="Delete" @confirm="confirmDeleteChat" @cancel="cancelDeleteChat" />
  </div>
</template>
